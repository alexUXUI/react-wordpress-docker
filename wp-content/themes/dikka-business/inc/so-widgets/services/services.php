...
class dikka_business_Services_Widget extends SiteOrigin_Widget {

	function __construct() {

		parent::__construct(
			'dikka-business-services',
			__( 'DB: Services', 'dikka-business' ),
			array(
...
siteorigin_widget_register( 'dikka-business-services', __FILE__, 'dikka_business_Services_Widget' );
